...
//指数/行业指数
public class F5_Index_IndexOfIndustry extends StockActivity {
	public void testCase001() throws Exception {
		CaseName = "行业指数_加入自选";
		this.windDeleteAllShares();
		new F5StockActivity().click_Stockname("CI005029.WI");
		...
		CaseCheck = this.EqualsChecked(solo.searchText("综合"));
