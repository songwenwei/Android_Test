...
//期货/期货即时走势/股指期货
public class F5_FuturesOfIndex extends StockActivity {
	...
	public void testCase001() throws Exception {
		...
		CaseCheck = this.EqualsChecked(F5_title.contains("IF1406"));// 校验分时页面标题
	...
	public void testCase005() throws Exception {
		CaseName = "点击【分时】";
		new F5StockActivity().click_Stockname("IF1406.CFE");// 进入分时页面
	...
	public void testCase009() throws Exception {
		...
		CaseCheck = this.EqualsChecked(solo.searchText("IF1406"));
		System.out.println(CaseCheck);
	}
