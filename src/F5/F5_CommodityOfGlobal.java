...
public class F5_CommodityOfGlobal extends StockActivity {
	...
	public void testCase001() throws Exception {
		...
		String F5_title = ((TextView) this.getViewById("book_name")).getText()
				.toString();// 获取分时页面标题
		CaseCheck = this.EqualsChecked(F5_title.contains("COMEX黄金"));// 校验分时页面标题
	...
	public void testCase002() throws Exception {
		CaseName = "点击【分时】";
		new F5StockActivity().click_Stockname("GC.CMX");// 进入分时页面
		...
		CaseCheck = this.EqualsChecked(time1.equalsIgnoreCase("18:00")
				&& time2.equalsIgnoreCase("17:15"));// 检验時間
		System.out.println(CaseCheck);
	...
	public void testCase006() throws Exception {
		...
		CaseCheck = this.EqualsChecked(solo.searchText("COMEX黄"));
		System.out.println(CaseCheck);
	}
